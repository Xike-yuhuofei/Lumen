...
from lumen.app.api.utils.progress_broadcaster import ProgressBroadcaster
from lumen.app.api.utils.task_id_manager import TaskIDManager
from lumen.app.api.utils.task_log_stream import capture_task_logs, get_task_stream_manager
...
from lumen.shared.knowledge.add_documents import DocumentAdder, remove_raw_document
from lumen.shared.knowledge.initializer import KnowledgeBaseInitializer
from lumen.shared.knowledge.kb_types import is_connected_kb, supports_local_raw_files
...
def _validate_registered_provider(raw_provider: str | None) -> str:
    ...
    compares the requested provider against the KB's bound provider, so adding to
...
async def websocket_progress(websocket: WebSocket, kb_name: str):
    ...
    from lumen.app.api.routers.auth import ws_auth_failed, ws_require_auth
