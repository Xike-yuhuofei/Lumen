...
stage. An engine turns bytes/path into a :class:`~lumen.shared.knowledge.parsing.types.ParsedDocument`
...
class Parser(Protocol):
    ...
    def parse(
        ...
        *,
        ...
        workdir via :func:`lumen.shared.knowledge.parsing.cache.load_ir` and
        writes the cache manifest. Raises :class:`ParserError` on failure.
        """
        ...
