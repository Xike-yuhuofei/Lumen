...
Kept in its own low-level module so both :mod:`lumen.shared.knowledge.manager`
...
def supports_local_raw_files(entry: Any) -> bool:
    """Whether the KB owns a Lumen-managed local ``raw/`` directory.
    ...
    Lumen's raw-file upload and management API.
    """
