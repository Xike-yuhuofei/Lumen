"""Legacy public-API shims for :mod:`lumen.shared.memory.store`.
...
from lumen.shared.memory.consolidator.modes.update import (
    UpdateResult,
    run_update,
)
from lumen.shared.memory.document import parse, serialize
from lumen.shared.memory.ops import ApplyReport, Op
