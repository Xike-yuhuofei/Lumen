...
for :mod:`lumen.shared.memory.store` so the public API surface
stays stable while the implementation switches under the hood.
"""

from __future__ import annotations

from lumen.shared.memory.consolidator.modes._shims import (
    consolidate_l2,
    consolidate_l3,
)
from lumen.shared.memory.consolidator.modes.audit import run_audit
...
from lumen.shared.memory.consolidator.modes.update import run_update
