...
from lumen.shared.memory.consolidator.chunker import (
    chunk_with_boundary,
)
from lumen.shared.memory.consolidator.meta import (
    load_l2_meta,
    load_l3_meta,
    save_l2_meta,
    save_l3_meta,
)
from lumen.shared.memory.consolidator.modes._runtime import (
    OnEvent,
    call_llm,
    emit,
    load_doc,
...
from lumen.shared.memory.consolidator.references import (
    ExtractedFact,
    refs_in_span_l2,
    refs_in_span_l3,
...
from lumen.shared.memory.document import Document, Entry, serialize
from lumen.shared.memory.ops import AddOp
from lumen.shared.memory.ops import apply as apply_ops
from lumen.shared.memory.paths import L3Slot, Surface
from lumen.shared.memory.settings import load_memory_settings
    ...
    *,
    ...
    if not new_entities:
        ...
        if settings.merge.auto_after_update:
            from lumen.shared.memory.consolidator.modes.merge import run_merge
    ...
    if settings.dedup.auto_after_update and facts_added > 0:
        ...
        from lumen.shared.memory.consolidator.modes.dedup import run_dedup
