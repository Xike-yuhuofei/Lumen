...
* :class:`ConsolidateResult`, :data:`OnEvent` — legacy types preserved
  for :mod:`lumen.shared.memory.store`.
...
from lumen.shared.memory.consolidator.guards import _filter_banned, _has_banned
from lumen.shared.memory.consolidator.modes import (
    consolidate_l2,
    consolidate_l3,
    run_audit,
    run_dedup,
...
from lumen.shared.memory.consolidator.parse import _parse_ops_response
