...
from lumen.shared.memory import consolidator, paths, trace
from lumen.shared.memory.consolidator import ConsolidateResult, OnEvent
from lumen.shared.memory.document import Document, parse, serialize
from lumen.shared.memory.ops import AddOp, ApplyReport, EditOp, OpResult
from lumen.shared.memory.ops import apply as ops_apply
...
_NO_MEMORY = (
    "(No memory available — interact with Lumen and update from the Memory page to build one.)"
)
...
class MemoryStore:
    ...
    async def apply_ops_payload(
        ...
        """
        from lumen.shared.memory.consolidator import _parse_ops_response
