...
def test_vertical_slice_full_loop() -> None:
    ...
    from deeptutor.learning.models import ErrorRecord, ErrorType, RetryAttempt
...
def test_teaching_service_vertical_slice(tmp_path: Path) -> None:
    ...
    from deeptutor.teaching_core.graph_repository import SQLiteTeachingGraphRepository
