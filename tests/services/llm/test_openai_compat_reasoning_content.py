...
from lumen.shared._util.llm.provider_core.openai_compat_provider import (
    OpenAICompatProvider as ServicesOpenAICompatProvider,
)
from lumen.shared._util.provider_registry import find_by_name as find_service_provider
...
# NOTE: moonshot-specific model_overrides were removed with the moonshot
# ProviderSpec (see provider_registry.py pruning); kimi-model temperature
# behavior is no longer wired to a registered provider.
